...
class state_from_mavros
{
        ...
        state_nh("~")
    {
        ...
        // TF luna
        range_sub = state_nh.subscribe<sensor_msgs::Range>(uav_name+ "/mavros/distance_sensor/hrlv_ez4_pub", 10,
                    &state_from_mavros::range_cb,this);
    ...
    private:
        ...
        ros::Subscriber attitude_sub, alt_sub, range_sub;
